...
with col2:
    ...
    if bed_share == "Volledige beddeldeling":
        ...
        for i in range(0, n_loc):
            with st.expander(st.text_input("",value="Location "+str(i+1))):
                beds_GRZ = st.number_input(f"Number of GRZ beds {i+1}", min_value=0, step=1, value=0, format="%d" )
                nurs_GRZ = st.number_input(f"Number of GRZ nurses {i+1}", min_value=0, step=1, value=0, format="%d")
                beds_High_Complex = st.number_input(f"Number of High Complex beds {i+1}", min_value=0, step=1, value=0, format="%d")
                nurs_High_Complex = st.number_input(f"Number of High Complex nurses {i+1}", min_value=0, step=1, value=0, format="%d")
                beds_ELV_Low = st.number_input(f"Number of ELV Low Complex beds {i+1}", min_value=0, step=1, value=0, format="%d")
                nurs_ELV_Low = st.number_input(f"Number of ELV Low Complex nurses {i+1}", min_value=0, step=1, value=0, format="%d")
                beds_ELV_EMRD = st.number_input(f"Number of Emergency beds {i+1}", min_value=0, step=1, value=0, format="%d")
        ...
        for i in range(0, n_loc):
            with st.expander(st.text_input("",value="Location "+str(i+1))):
                ...
                beds_ELV_Low = st.number_input(f"Number of ELV Low Complex beds {i+1}", min_value=0, step=1, value=0, format="%d")
                nurs_ELV_Low = st.number_input(f"Number of ELV Low Complex nurses {i+1}", min_value=0, step=1, value=0, format="%d")
                beds_ELV_Shared = st.number_input(f"Number of Shared beds {i+1}", min_value=0, step=1, value=0, format="%d")
                beds_ELV_EMRD = st.number_input(f"Number of Emergency beds {i+1}", min_value=0, step=1, value=0, format="%d")
                beds_High.append(beds_High_Complex)
                beds_low.append(beds_ELV_Low)
                beds_G.append(beds_GRZ)
