...
default_values = {
    "Aankomst Hoog Complex vanuit ziekenhuis per dag": 0.0,
    "Aankomst vanaf Huisarts Hoog Complex per dag": 0.0,
    "Aankomst vanaf de Spoedeisendehulp per dag": 0.0,
    "Aankomst Geriatrische Zorg in Ziekenhuis per dag": 0.0,
    "Aankomst Laag Complexe zorg vanaf de Huisarts": 0.0,
    "Ligduur Hoog Complex naar Huis": 0.0,
    "Ligduur Geriatrische Zorg naar Huis": 0.0,
    "Ligduur Hoog Complex Dood": 0.0,
    "Ligduur Geriatrische Zorg Dood": 0.0,
    "Ligduur Hoog Complex naar Geriatrische Zorg": 0.0,
    "Ligduur Hoog Complex naar Huis met aanpassingen": 0.0,
    "Ligduur Geriatrische Zorg naar Huis met aanpassingen": 0.0,
    "Ligduur Hoog Complex WMO": 0.0,
    "Ligduur Hoog Complex WLZ": 0.0,
    "Ligduur Geriatrische zorg WMO": 0.0,
    "Ligduur Geriatrische Zorg WLZ": 0.0,
    "Ligduur Laag Complex naar Huis": 0.0,
    "Ligduur Laag Complex Dood": 0.0,
    "Ligduur Laag Complex Geriatrische Zorg": 0.0,
    "Ligduur Laag Complex naar Huis met aanpassingen": 0.0,
    "Ligduur Laag Complex WMO": 0.0,
    "Ligduur Laag Complex WLZ": 0.0,
    "Percentage Hoog Complex naar Huis": 0.0,
    "Percentage Geriatrische Zorg naar Huis": 0.0,
    "Percentage Hoog Complex Dood": 0.0,
    "Percentage Geriatrische Zorg Dood": 0.0,
    "Percentage Hoog Complex WMO": 0.0,
    "Percentage Geriatrische Zorg WMO": 0.0,
    "Percentage Hoog Complex WLZ": 0.0,
    "Percentage Geriatrische Zorg WLZ": 0.0,
    "Percentage Hoog Complex naar Geriatrische Zorg": 0.0,
    "Percentage Hoog Complex naar Huis met aanpassingen": 0.0,
    "Percentage Geriatrische Zorg naar Huis met aanpassingen": 0.0,
    "Percentage Laag Complex naar Huis": 0.0,
    "Percentage Laag Complex Dood": 0.0,
    "Percentage Laag Complex WMO": 0.0,
    "Percentage Laag Complex WLZ": 0.0,
    "Percentage Laag Complex naar Geriatrische Zorg": 0.0,
    "Percentage Laag Complex naar Huis met aanpassingen": 0.0,
    "Opening_weekday": 0.0,
    "Spoedeisendehulp openingstijd": 0.0,
    "Spoedeisendehulp sluitingstijd": 0.0,
    "Openingstijd Huisarts": 0.0,
    "Sluittijd Huisarts": 0.0,
    "Opname in het weekend": 0.0,
    "Openingstijd ELV": 0.0,
    "Sluitingstijd ELV": 0.0,
    "Aantal patienten per verpleegkundige": 0.0,
    "Transfertijd": 0.0,
    "Maximaal aantal dagen observatie": 0.0,
    "Aantal subruns": 0.0,
    "Aantal patienten per subrun": 0.0,
    "Aantal patienten voor warming": 0.0,
}
...
#         n_subruns = input.loc[loop_nr,'n_subruns']
        
#         n_clients_per_subrun = input.loc[loop_nr,'patienten per subrun']
#         n_clients_for_warming = input.loc[loop_nr,'patienten voor warming']
    
#         print_modus = False  
    
#         arr_HOS_High =  input.loc[loop_nr,'Arrival HOS High per dag']
#         arr_HOS_GRZ = input.loc[loop_nr,'Arrival GRZ per dag']
#         arr_GPR_High = input.loc[loop_nr,'Arrival GPR High per dag']
#         arr_GPR_Low = input.loc[loop_nr,'Arrival GPR Low per dag']
    
#         arr_EMD = input.loc[loop_nr,'Arrival EMD per dag']
        
        
        
#         out_p_Home_High = input.loc[loop_nr,'Percentage uitstroom Home High Complex']
#         out_p_Dead_High = input.loc[loop_nr,'Percentage uitstroom Dead High Complex']
#         out_p_WMO_High = input.loc[loop_nr,'Percentage uitstroom WMO High Complex']
#         out_p_WLZ_High = input.loc[loop_nr,'Percentage uitstroom WLZ High Complex']
#         out_p_GRZV_High = input.loc[loop_nr,'Percentage uitstroom GRZ care High Complex']
#         out_p_Pall_High = input.loc[loop_nr,'Percentage uitstroom Home with adjustments High Complex']
        
#         out_p_Home_Low = input.loc[loop_nr,'Percentage uitstroom Home Low Complex']
#         out_p_Dead_Low = input.loc[loop_nr,'Percentage uitstroom Dead Low Complex']
#         out_p_WMO_Low = input.loc[loop_nr,'Percentage uitstroom WMO Low Complex']
#         out_p_WLZ_Low = input.loc[loop_nr,'Percentage uitstroom WLZ Low Complex']
#         out_p_GRZV_Low = input.loc[loop_nr,'Percentage uitstroom GRZ care Low Complex']
#         out_p_Pall_Low = input.loc[loop_nr,'Percentage uitstroom Home with adjustments Low Complex']
        
#         serv_Home_High = 1/input.loc[loop_nr,'Ligduur High complex care Home']
#         serv_Dead_High = 1/input.loc[loop_nr,'Ligduur High complex care Dead']
        
#         serv_GRZV_High = 1/input.loc[loop_nr,'Ligduur High complex care GRZV']
#         serv_Pall_High = 1/input.loc[loop_nr,'Ligduur High complex care Hwa']
#         serv_WMO_High = 1/input.loc[loop_nr,'Ligduur High complex care WMO']
#         serv_WLZ_High = 1/input.loc[loop_nr,'Ligduur High complex care WLZ']
        
#         serv_Home_Low = 1/input.loc[loop_nr,'Ligduur laag complex care Home']
#         serv_Dead_Low = 1/input.loc[loop_nr,'Ligduur laag complex care Dead']
        
#         serv_GRZV_Low = 1/input.loc[loop_nr,'Ligduur laag complex care GRZV']
#         serv_Pall_Low = 1/input.loc[loop_nr,'Ligduur laag complex care Hwa']
#         serv_WMO_Low = 1/input.loc[loop_nr,'Ligduur laag complex care WMO']
#         serv_WLZ_Low = 1/input.loc[loop_nr,'Ligduur laag complex care WLZ']
    
        
#         time_max_opn_ELV = input.loc[loop_nr,'ELV eindtijd']/24
#         ELV_start_time = input.loc[loop_nr,'ELV starttijd']/24
    
#         EMD_start_time = input.loc[loop_nr,'EMD starttijd']/24
#         EMD_end_time = input.loc[loop_nr,'EMD eindtijd']/24
#         GPR_start_time = input.loc[loop_nr,'Huisarts starttijd']/24
#         GPR_end_time = input.loc[loop_nr,'Huisarts eindtijd']/24
    
        
#         p_opn_weekend = input.loc[loop_nr,'Open weekend']
    
#         Scen_tr_ward = input.loc[loop_nr,'Scen_TRW']
...
#         priority = input.loc[loop_nr,'Priority Holds']
#         Project = ''#input.loc[loop_nr,'Project']
#         Preference = input.loc[loop_nr,'Preference Type'] #Pref = pref_model, FCFS = FCFS, NO = Only fav location
#         n_patients_per_nurse = input.loc[loop_nr,'Number of patients per nurse']
        
        
        
        
#         adm_days = 1/input.loc[loop_nr,'Adm_days']
    
        
#         max_days_TRW = input.loc[loop_nr,'Maximaal aantal dagen TRW']
    
    
        
#         out_p_Home_GRZ = input.loc[loop_nr,'Percentage uitstroom Home GRZ']
#         out_p_Dead_GRZ = input.loc[loop_nr,'Percentage uitstroom Dead GRZ']
#         out_p_WMO_GRZ = input.loc[loop_nr,'Percentage uitstroom WMO GRZ']
#         out_p_WLZ_GRZ = input.loc[loop_nr,'Percentage uitstroom WLZ GRZ']
#         out_p_GRZV_GRZ = input.loc[loop_nr,'Percentage uitstroom GRZ care GRZ']
#         out_p_Pall_GRZ = input.loc[loop_nr,'Percentage uitstroom Home with adjustments GRZ']
        
#         serv_Home_GRZ = 1/input.loc[loop_nr,'Ligduur GRZ care Home']
#         serv_Dead_GRZ = 1/input.loc[loop_nr,'Ligduur GRZ care Dead']
#         serv_GRZV_GRZ = 0#1/input.loc[loop_nr,'serv_GRZV_GRZ']
#         serv_Pall_GRZ = 1/input.loc[loop_nr,'Ligduur GRZ care Hwa']
#         serv_WMO_GRZ = 1/input.loc[loop_nr,'Ligduur GRZ care WMO']
#         serv_WLZ_GRZ = 1/input.loc[loop_nr,'Ligduur GRZ care WLZ']
