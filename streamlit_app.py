    ...
    if bed_share == "Volledige beddeldeling":
        ...
        for i in range(0, n_loc):
            with st.expander(st.text_input("",value="Location "+str(i+1))):
                ...
                beds_ELV_High = st.number_input("Number of ELV High Complex beds", min_value=0, step=1, value=0, format="%d")
                nurs_ELV_High = st.number_input("Number of ELV High Complex nurses", min_value=0, step=1, value=0, format="%d")
        ...
        for i in range(0, n_loc):
            with st.expander(st.text_input("",value="Location "+str(i+1))):
                beds_GRZ = st.number_input("Number of GRZ beds", min_value=0, step=1, value=0)
                nurs_GRZ = st.number_input("Number of GRZ nurses", min_value=0, step=1, value=0)
                beds_High_Complex = st.number_input("Number of High Complex beds", min_value=0, step=1, value=0)
                nurs_High_Complex = st.number_input("Number of High Complex nurses", min_value=0, step=1, value=0)
                beds_ELV_Low = st.number_input("Number of ELV Low Complex beds", min_value=0, step=1, value=0)
                nurs_ELV_Low = st.number_input("Number of ELV Low Complex nurses", min_value=0, step=1, value=0)
                beds_ELV_EMRD = st.number_input("Number of Emergency beds", min_value=0, step=1, value=0)
